...
<div id="wrapper">
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="uview.jsp">View files</a></li>
				<li><a href="ustatus.jsp">Status</a></li>
			...
			<div id="page-bgbtm">
				...
				<div id="sidebar" style="width: 522px;">
					<ul>
						...
						<li>
						<form name="form" action="filereq.jsp?fid=<%=id %>" method="post" onsubmit="return validation()">
