...
<!-- 				<div id=" splash">&nbsp;</div> -->
					...
					<ul>
						<li>
							<h2>User Uploaded File Details</h2>
							<%if(msg!=null){ %>
							<p><%=msg%></p>
							<%} %>
						</li>
						...
						<table  border='1' bgcolor="#e9cfec" cellpadding="px">
						<tr><th>ID</th>
						<th>File Name</th>
						<th>File</th>
						<th>Date</th>
						...
						<td><a href="temp1.jsp?id=<%=rs.getString(8)%>"><font color="blue"><u>Download</u></font></a></td>
						...
						<td><a href="temp2.jsp?id=<%=rs1.getString(8)%>"><font color="blue"><u>Download</u></font></a></td>
