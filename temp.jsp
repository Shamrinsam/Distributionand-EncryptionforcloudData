...
<%
	...
	ResultSet rs = null;
		String sql=null;
		Connection con=null;
	if(request.getParameter("server").equalsIgnoreCase("0")){
		
	 sql = "select AES_DECRYPT(file,'key') from file where fid=?";
	}
	else{
		sql = "select AES_DECRYPT(file,'key') from file2 where fid=?";
	}
	try
	{
